...
export default function Home() {
  return (
    <main className="flex-1 overflow-scroll p-2 lg:p-5 bg-gradient-to-bl from-white to-indigo-600 dark:from-gray-600 dark:to-indigo-600">
      <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl dark:bg-slate-900">
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-6xl dark:text-gray-100">
        ...
        <div className="relative overflow-hidden pt-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div aria-hidden="true" className="relative">
              <div className="absolute bottom-0 -inset-x-32 bg-gradient-to-t from-white/95 pt-[5%] dark:from-slate-900/95" />
            </div>
          </div>
        </div>
